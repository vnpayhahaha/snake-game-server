...
class ApiGenerator extends MineGenerator implements CodeGenerator
{
    ...
    public function generator(): void
    {
        ...
        $this->filesystem->makeDirectory(BASE_PATH . "/runtime/generate/vue/src/modules/{$module}/api/", 0755, true, true);
        $path = BASE_PATH . "/runtime/generate/vue/src/modules/{$module}/api/{$filename}.ts";
