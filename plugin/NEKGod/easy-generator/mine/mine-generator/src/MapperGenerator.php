...
class MapperGenerator extends MineGenerator implements CodeGenerator
{
    ...
    public function generator(): void
    {
        ...
        if ($this->tablesContract->getGenerateType()->value === 1) {
            $path = BASE_PATH . "/runtime/generate/php/app/Repository/$module/";
        } else {
            $path = BASE_PATH . "/app/Repository/$module/";
        }
    ...
    {
        return "App\\Repository\\{$this->tablesContract->getPackageName()}";
    }
    ...
    {
        return $this->tablesContract->getMenuName() . ' Repository类';
    }
