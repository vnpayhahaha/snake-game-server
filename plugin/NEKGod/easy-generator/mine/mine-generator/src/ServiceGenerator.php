...
class ServiceGenerator extends MineGenerator implements CodeGenerator
{
    ...
    public function generator(): void
    {
        ...
        if ($this->tablesContract->getGenerateType()->value === 1) {
            $path = BASE_PATH . "/runtime/generate/php/app/Service/$module/";
        } else {
            $path = BASE_PATH . "/app/Service/$module/";
        }
    ...
    {
        return "App\\Service\\{$this->tablesContract->getNamespace()}";
    }
    ...
    {
        return <<<UseNamespace
use App\\Repository\\{$this->tablesContract->getPackageName()}\\{$this->getBusinessName()}Repository;
UseNamespace;
    }
    ...
    {
        return $this->getBusinessName() . 'Repository';
    }
