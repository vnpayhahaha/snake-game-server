...
class VueIndexGenerator extends MineGenerator implements CodeGenerator
{
    ...
    public function generator(): void
    {
        ...
        $path = BASE_PATH . "/runtime/generate/vue/src/modules/{$module}/views/{$this->getShortBusinessName()}/index.vue";
    ...
    protected function getReplaceContent(): array
    {
        return [
            ...
            $this->getModuleName(),
            $this->getPk(),
            ($this->tablesContract->options['tag_name'] ?? $this->tablesContract->table_comment)
        ];
    }
