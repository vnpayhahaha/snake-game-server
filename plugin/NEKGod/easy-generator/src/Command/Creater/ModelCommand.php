...
use CodeHyperf\Database\Commands\Ast\GenerateModelIDEVisitor;
use CodeHyperf\Database\Commands\Ast\ModelRewriteConnectionVisitor;
use CodeHyperf\Database\Commands\Ast\ModelUpdateVisitor;
...
#[Command]
class ModelCommand extends MineCommand
{
    ...
    {
        parent::__construct('codeGen:model');
    ...
    protected function createModel(string $table, ModelOption $option): void
    {
        ...
        foreach ($option->getVisitors() as $visitorClass) {
            $visitorClass = str_replace("Hyperf", "CodeHyperf", $visitorClass);
