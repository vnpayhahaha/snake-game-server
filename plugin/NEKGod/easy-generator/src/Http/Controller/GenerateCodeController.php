...
use Plugin\NEK\CodeGenerator\Request\GenerateRequest;
use Plugin\NEK\CodeGenerator\Service\SettingGenerateColumnsService;
...
//    protected SettingDatasourceService $datasourceService;
    ...
    public function index(): ResponseInterface
    {
        ...
        return $this->success($this->tableService->getPageList($data));
    }
    ...
    {
        return $this->tableService->updateTableAndColumns($this->request->post()) ? $this->success() : $this->error();
    }
