...
class SettingGenerateColumns extends MineModel
{
     ...
     */
    protected array $fillable = ['id', 'table_id', 'column_name','query_form_type', 'column_comment', 'column_type', 'is_pk', 'is_required', 'is_insert', 'is_edit', 'is_list', 'is_query', 'is_sort', 'query_type', 'view_type', 'dict_type', 'allow_roles', 'options', 'extra', 'sort', 'created_by', 'updated_by', 'created_at', 'updated_at', 'remark'];
