...
namespace Plugin\MineAdmin\Tenant\Exception\Handler;
...
final class TenantExceptionHandler extends ExceptionHandler
{
    use Debugging;
    ...
    public function handle(\Throwable $throwable, ResponsePlusInterface $response): mixed
    {
    ...
    {
        return $throwable instanceof TenantException;
    }
}
