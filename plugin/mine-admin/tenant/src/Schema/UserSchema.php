...
namespace Plugin\MineAdmin\Tenant\Schema;
...
use Plugin\MineAdmin\Tenant\Vo\UserVo;
...
final class UserSchema implements \JsonSerializable
{
    ...
    #[Property(property: 'tenant', title: '用户名', type: 'array')]
    public Tenant $tenant;

    public function __construct(UserVo $model)
    {
        $this->id = $model->id;
    ...
    {
        return ['id' => $this->id, 'tenant' => $this->tenant, 'username' => $this->username, 'user_type' => $this->userType, 'nickname' => $this->nickname, 'phone' => $this->phone, 'email' => $this->email, 'avatar' => $this->avatar, 'signed' => $this->signed, 'status' => $this->status, 'login_ip' => $this->loginIp, 'login_time' => $this->loginTime, 'backend_setting' => $this->backendSetting, 'created_by' => $this->createdBy, 'updated_by' => $this->updatedBy, 'created_at' => $this->createdAt, 'updated_at' => $this->updatedAt, 'remark' => $this->remark];
    }
}
